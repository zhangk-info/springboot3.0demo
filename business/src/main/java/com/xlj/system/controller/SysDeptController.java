...
public class SysDeptController extends BaseController {
    ...
    @GetMapping("/list")
    public DataResp list(SysDept dept) {
    ...
    public DataResp excludeChild(@PathVariable(value = "deptId", required = false) Long deptId) {
    ...
    public DataResp getInfo(@PathVariable Long deptId) {
    ...
    @PostMapping
    public DataResp add(@Validated @RequestBody SysDept dept) {
    ...
    @PutMapping
    public DataResp edit(@Validated @RequestBody SysDept dept) {
    ...
    public DataResp remove(@PathVariable Long deptId) {
