...
public class SysPostController extends BaseController
{
    ...
    {
        List<SysPost> list = postService.selectPostList(post);
        ExcelUtil.exportExcel(response, list, "岗位数据");
    }
    ...
    public DataResp getInfo(@PathVariable Long postId)
    {
    ...
    @PostMapping
    public DataResp add(@Validated @RequestBody SysPost post)
    {
    ...
    @PutMapping
    public DataResp edit(@Validated @RequestBody SysPost post)
    {
        if (UserConstants.NOT_UNIQUE.equals(postService.checkPostNameUnique(post)))
        {
    ...
    public DataResp remove(@PathVariable Long[] postIds)
    {
