...
public class SysMenuController extends BaseController {
    ...
    @GetMapping("/list")
    public DataResp list(SysMenu menu) {
    ...
    public DataResp getInfo(@PathVariable Long menuId) {
    ...
    public DataResp treeselect(SysMenu menu) {
        List<SysMenu> menus = menuService.selectMenuList(menu, getUserId());
    ...
    @PostMapping
    public DataResp add(@Validated @RequestBody SysMenu menu) {
    ...
    @PutMapping
    public DataResp edit(@Validated @RequestBody SysMenu menu) {
        if (UserConstants.NOT_UNIQUE.equals(menuService.checkMenuNameUnique(menu))) {
    ...
    public DataResp remove(@PathVariable("menuId") Long menuId) {
