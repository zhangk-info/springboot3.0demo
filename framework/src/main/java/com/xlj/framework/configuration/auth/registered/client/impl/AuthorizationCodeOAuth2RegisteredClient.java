package com.xlj.framework.configuration.auth.registered.client.impl;//package com.xlj.configuration.auth.registered.client.impl;
//
//import com.xlj.configuration.auth.token.OAuth2TokenSettings;
