...
CREATE TABLE `users`  (
  ...
  `last_store_id` int(11) NULL DEFAULT NULL COMMENT '登录后默认选择的store_id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 117 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户表' ROW_FORMAT = Dynamic;


-- 插入一条默认数据用于测试
INSERT INTO `users`(`openid`, `mobile`, `password`, `username`, `nickname`, `cover_url`, `company_name`, `province_id`, `province`, `city_id`, `city`, `district_id`, `district`, `create_at`, `update_at`, `delete_at`, `is_delete`, `last_store_id`, `balance`, `address`) VALUES ('', '17780592197', 'f1c830a6ccac94c973bf51afa4cb5423', NULL, '', 'https://zhubao-xinglianjin.oss-cn-chengdu.aliyuncs.com/site/20221227/cMxS70FTyBJaerqkzxaa0yz8f7h8M8OFO3dCAJ8J.png', '光合首饰', 110000, '北京市', 110100, '北京城区', 110106, '丰台区', '2022-10-26 11:41:47', '2022-12-27 17:19:18', '2022-10-26 11:41:47', 0, 1, 140.00, '梨花街88号0');
